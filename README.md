...
| [skills/](./skills/)                                           | **How** — the flight manual as agent skills: [deblob](./skills/deblob/SKILL.md) (architecture ground rules), [deblob-commit](./skills/deblob-commit/SKILL.md) (commit as level-0 spec), [deblob-review](./skills/deblob-review/SKILL.md) (pre-checkpoint pass); sdd skill coming. The knowledge layer: self-contained cards, question-indexed, provenance-stamped ([INDEX](./skills/deblob/knowledge/INDEX.md)) |

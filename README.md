...
| [skills/](./skills/)                                             | **How** — the flight manual as agent skills: [deblob](./skills/deblob/SKILL.md) (architecture ground rules); commit / review / sdd skills coming. Each skill carries its [knowledge/](./skills/deblob/knowledge/INDEX.md) layer — self-contained cards, question-indexed, provenance-stamped |
